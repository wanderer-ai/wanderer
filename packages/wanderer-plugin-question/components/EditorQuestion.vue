<template>
  <div>
    ...
    <div class="form-group">
      <label for="label">simpleProp</label>
      <input v-model="simpleProp" type="text" class="form-control" id="label" placeholder="Enter your prop">
    </div>
    {{simpleProp}}
...
export default {
  computed: {
    ...
    simpleProp: WandererBuilder.getVertexModel('simpleProp'),
